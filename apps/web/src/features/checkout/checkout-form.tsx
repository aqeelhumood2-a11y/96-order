...
export function CheckoutForm({ availableSlots, pickupLocationName, pickupLocationAddress }: CheckoutFormProps) {
  ...
  return (
    <form id={formId} onSubmit={handleSubmit} className="flex flex-col gap-8">
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          <label className="flex items-center gap-2 text-sm">
            <input type="radio" name="fulfillment" value="delivery" checked={fulfillmentMethod === "delivery"} onChange={() => setFulfillmentMethod("delivery")} />
            Delivery
          </label>
          <label className="flex items-center gap-2 text-sm">
      ...
      <Button type="submit" size="lg" disabled={pending || !firstAvailableSlot}>
